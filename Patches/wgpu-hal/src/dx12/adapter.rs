    ...
    pub(super) fn expose(
        ...
        assert_eq!(0, unsafe {
            device.CheckFeatureSupport(
                ...
                size_of::<d3d12::D3D12_FEATURE_DATA_ARCHITECTURE>() as _,
            )
        });
        ...
        assert_eq!(0, unsafe {
            device.CheckFeatureSupport(
                ...
                size_of::<d3d12::D3D12_FEATURE_DATA_SHADER_MODEL>() as _,
            )
        });
        ...
        assert_eq!(0, unsafe {
            device.CheckFeatureSupport(
                ...
                size_of::<d3d12::D3D12_FEATURE_DATA_D3D12_OPTIONS>() as _,
            )
        });
        ...
        let _depth_bounds_test_supported = {
            ...
            let hr = unsafe {
                device.CheckFeatureSupport(
                    ...
                    size_of::<d3d12::D3D12_FEATURE_DATA_D3D12_OPTIONS2>() as _,
                )
            };
